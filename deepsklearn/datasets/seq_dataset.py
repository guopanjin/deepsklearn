...
class  TorchStreamingSeqDataset(IterableDataset):
   def __init__(self,data_path,feature_columns,label_columns,batch_size=1000):
   ...
   def __parse_data(self,file):
       ...
       for batch in parquet_file.iter_batches(batch_size=self.batch_size):
           ...
           label_dict={label_config:batch_df[label_config].to_numpy() for label_config in self.label_columns}
